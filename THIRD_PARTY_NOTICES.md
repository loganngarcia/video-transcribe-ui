...
- **USR 2.0**, Andreas Haliassos and collaborators: https://github.com/ahaliassos/usr2. Revision `df0c78b7a3807e625a0fcdadd14b1cf674d21c91`. CC BY-NC 4.0. Downloaded separately, unmodified. This project adds a persistent video-only adapter, normalization and web application. See upstream README for paper citation.
